      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <section class="col-lg-5 connectedSortable">
            ...
            <!-- Calendar -->
            <div class="card bg-gradient-primary" id="calendar_click">
            ...
            <div class="row">
              ...
              <div class="col-5 mb-5" style="position: relative;">
                <div class="row ">
                <div class="col-8 " >
                  <div class="card-body" >
                ...
                <div class="col-4 mt-5">
                  <ul class="chart-legend clearfix ">
                    <li><i class="far fa-circle text-success"></i> Balance</li>
                    <li><i class="far fa-circle text-primary"></i> Used</li>
                  </ul>
                </div>
              </div>
              </div>
